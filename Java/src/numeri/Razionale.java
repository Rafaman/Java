...
public class Razionale implements Comparable<Razionale> {
     ...
     * Il numero � sempre ridotto ai minimi termini
     */
     ...
     * due interi.
     *
     * @param numeratore   sar� il numeratore del razionale
     * @param denominatore sar� il denominatore del razionale.
    ...
    public Razionale(Razionale r) {
        ...
        // Soluzione pi� elegante ma meno efficiente:
    ...
    public Razionale() {
        numeratore = 0;
        denominatore = 1;
        // Soluzioni pi� eleganti ma meno efficienti:
        //this(0);
        //oppure
        //this(0,1);
    }
    ...
    /**
     * Verifica se l'oggetto � uguale ad un altro razionale.
     *
     * @param o un oggetto che deve essere
     *          un razionale
     * @return true, se l'oggetto � uguale
