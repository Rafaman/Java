...
public class TestData{
    public static void main(String[] args) {
        Data oggi = new Data();
        Data d = new Data(31, 8, 2020);
        Data domani = oggi.giornoSuccessivo();
        Data dNext = d.giornoSuccessivo();
        Data ieri = oggi.giornoPrima();
        //int distanza = oggi.distanzaGiorni(d);

        if(Data.isBisestile(2020)) System.out.println("E' bisestile!");
        else System.out.println("Non è bisestile");
        System.out.println("Giorno odierno: " + oggi.get(Data.Cosa.G));
        System.out.println("Oggi e' " + oggi);
        System.out.println("Domani e' " + domani);
        System.out.println("Dopodata e' " + dNext);
        System.out.println("Ieri era " + ieri);
        //System.out.println("Tra " + oggi + " e " + d + " trascorrono " + distanza + " giorni");
    }
}
