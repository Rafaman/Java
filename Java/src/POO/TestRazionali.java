...
public class TestRazionali {
    public static void main(String[] args) {
        Razionale r1 = new Razionale(3,9);
        Razionale r2 = new Razionale(4,6);
        Razionale r3 = new Razionale(2,10);
        Razionale r4 = new Razionale(2,12);

        Razionale r = r3.sottrai(r1.moltiplica(r2)).aggiungi(r4);
        System.out.println("Risultato: " + r);
        System.out.println("Numero Razionali: " + Razionale.quantiRazionali());
    }
}
class Razionale {
